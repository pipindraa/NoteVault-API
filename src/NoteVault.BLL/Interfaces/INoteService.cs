...
namespace NoteVault.BLL.Interfaces
{
    public interface INoteService
    {
        ...
        Task<Result<NoteResponseDto>> GetByIdAsync(Guid userId, Guid id, CancellationToken cancellationToken = default);
        Task<Result<NoteResponseDto>> CreateAsync(Guid userId, NoteCreateDto request, CancellationToken cancellationToken = default);
        Task<Result<NoteResponseDto>> UpdateAsync(Guid userId, Guid id, NoteUpdateDto request, CancellationToken cancellationToken = default);
