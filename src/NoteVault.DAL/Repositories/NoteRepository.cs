...
namespace NoteVault.DAL.Repositories
{
    public class NoteRepository : INoteRepository
    {
        ...
        public async Task<List<Note>> GetPageAsync<TKey>(Guid userId, Expression<Func<Note, TKey>> orderBy, int pageNumber, int pageSize, bool descending = true, CancellationToken cancellationToken = default)
        {
            var query = _notes
